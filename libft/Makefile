...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/09/13 20:15:06 by kbethel           #+#    #+#              #
#    Updated: 2020/05/07 18:10:28 by andrey           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libft.a

SRC = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_countwords.c \
	  ft_isdigit.c ft_isprint.c ft_lstiter.c ft_lstmap.c ft_sqrt.c ft_recursive_factorial.c \
	  ft_itoa.c ft_lstnew.c ft_lstadd.c ft_lstdel.c ft_lstdelone.c ft_sort_wordtab.c \
	  ...
	  ft_striteri.c ft_strjoin.c ft_strlcat.c ft_strlen.c ft_swap.c \
...
OBJS = ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o ft_countwords.o \
	   ft_isdigit.o ft_isprint.o ft_lstiter.o ft_lstmap.o ft_sqrt.o ft_recursive_factorial.o \
	   ft_itoa.o ft_lstnew.o ft_lstadd.o ft_lstdel.o ft_lstdelone.o ft_sort_wordtab.o \
	   ...
	   ft_striteri.o ft_strjoin.o ft_strlcat.o ft_strlen.o ft_swap.o \
